...
def display_forecast(forecast_data):
    ...
    forecast_list = forecast_data['list'][:32]  # 4 days * 8 entries/day
    ...
    for entry in forecast_list:
        ...
        Label(forecast_inner_frame, text=text, font=('Arial', 10), bg='#E5D4FF', anchor='w', justify=LEFT).pack(anchor='w', padx=10, pady=5)
...
Button(app, text="Search Weather", font=('Arial', 12), command=search).pack()

location_lbl = Label(app, font=('bold', 16), bg='#BFACE2')
location_lbl.pack()

temp_lbl = Label(app, font=('Arial', 12), bg='#BFACE2')
temp_lbl.pack()

weather_lbl = Label(app, font=('Arial', 12), bg='#BFACE2')
weather_lbl.pack()

humidity_lbl = Label(app, font=('Arial', 12), bg='#BFACE2')
humidity_lbl.pack()

wind_lbl = Label(app, font=('Arial', 12), bg='#BFACE2')
wind_lbl.pack()

datetime_lbl = Label(app, font=('Arial', 10), bg='#BFACE2')
datetime_lbl.pack()

Label(app, text="4-Day Forecast", font=('bold', 14), bg='#BFACE2').pack(pady=10)


# Scrollable Frame
forecast_frame = Frame(app, bg='#BFACE2')
forecast_frame.pack(padx=10, pady=5, fill='both', expand=True)

canvas = Canvas(forecast_frame, bg='#E5D4FF', highlightthickness=0)
scrollbar = Scrollbar(forecast_frame, orient="vertical", command=canvas.yview)
forecast_inner_frame = Frame(canvas, bg='#E5D4FF')
